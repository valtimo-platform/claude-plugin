...
// Only for the `documenten-api-file` upload component the document fixture's start form
// uses: it posts to core Valtimo's `v1/resource/temp` and hands back the temporary
// resource id the Ask Claude action takes. The rest of ZGW is unused here.
import {registerDocumentenApiFormioUploadComponent, ZgwModule} from "@valtimo/zgw";
import {environment} from "../environments/environment";

import {ClaudePluginModule, claudePluginSpecification,} from "@valtimo-plugins/claude-plugin";
